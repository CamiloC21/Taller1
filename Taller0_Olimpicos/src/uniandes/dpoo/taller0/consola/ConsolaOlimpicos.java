...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el pais que representa el atleta");
	...
	private void ejecutarPaisdeAtleta()
	{
		...
		String atleta = input("Por favor ingrese el nombre del atleta que desea consultar ");
		
		System.out.println(atleta);
		System.out.println("Pais: " + calculadora.paisPorAtleta(atleta));
